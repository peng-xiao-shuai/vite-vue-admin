  ...
  <el-drawer
    ...
    <el-form :model="currentFrom"
      ...
      <el-form-item label="建筑物名称：" prop="buildingName">
        <el-input v-model="currentFrom.buildingName" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="建筑层数：" prop="buildingFloors">
        <el-input v-model="currentFrom.buildingFloors" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="建筑高度：" prop="buildingHeightb">
        <el-input v-model="currentFrom.buildingHeightb" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="标准话建设情况：" prop="construction">
        <el-input v-model="currentFrom.construction" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      ...
      <el-form-item label="叉车数量：" prop="forkliftNumber">
        <el-input v-model="currentFrom.forkliftNumber" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      ...
      <el-form-item label="乘客电梯数量：" prop="passengerElevatorNumber">
        <el-input v-model="currentFrom.passengerElevatorNumber" style="width:80%"></el-input>
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
