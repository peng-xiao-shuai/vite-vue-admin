import{_ as m,d,y as c,r as t,o as p,c as l,a as r,w as u}from"./vendor.8c3eb18c.js";const h=d({name:"md-preview",setup(e,{emit:o}){return{text:c(`
...
`)}}}),v={class:"app-container"};function g(e,o,a,k,w,f){const i=t("view-name"),s=t("v-md-preview"),n=t("el-card");return p(),l("div",v,[r(n,{shadow:e.defaultData.cardShadow},{default:u(()=>[r(i),r(s,{text:e.text},null,8,["text"])]),_:1},8,["shadow"])])}var b=m(h,[["render",g]]);export{b as default};
