import{_ as m,d,D as p,r as t,b as c,c as l,e as r,j as u}from"./vendor.0885f2d9.js";const h=d({name:"md-preview",setup(e,{emit:o}){return{text:p(`
...
`)}}}),v={class:"app-container"};function g(e,o,a,k,w,f){const i=t("view-name"),s=t("v-md-preview"),n=t("el-card");return c(),l("div",v,[r(n,{shadow:e.defaultData.cardShadow},{default:u(()=>[r(i),r(s,{text:e.text},null,8,["text"])]),_:1},8,["shadow"])])}var b=m(h,[["render",g]]);export{b as default};
