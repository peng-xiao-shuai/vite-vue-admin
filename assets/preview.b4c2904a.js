import{_ as m}from"./index.39723eb2.js";import{d,C as p,r as t,b as c,c as l,e as r,i as u}from"./vendor.f934f7ac.js";const h=d({name:"md-preview",setup(e,{emit:o}){return{text:p(`
...
`)}}}),v={class:"app-container"};function g(e,o,a,k,f,w){const i=t("view-name"),s=t("v-md-preview"),n=t("el-card");return c(),l("div",v,[r(n,{shadow:e.defaultData.cardShadow},{default:u(()=>[r(i),r(s,{text:e.text},null,8,["text"])]),_:1},8,["shadow"])])}var x=m(h,[["render",g]]);export{x as default};
